...
cd frontend && TARTIB_PASSWORD=... npm run ui   # 20 UI checks, needs the app up and real Chrome
...
holds 20 checks over slices 22 to 25, 27, 29 and 31 to 34 (the Pick modal, link rendering and the `[[` picker, space links, the proposed-link and `relink` cards) -- contrast on the surface an element actually sits on,
